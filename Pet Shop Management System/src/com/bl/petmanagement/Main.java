...
//        System.out.println("1-BLACK, 2-RED, 3-BLACK_WHITE, 4-GREEN, 5-WHITE");
		/*
		 * Arrays.asList(Pet.Colour.values()) .forEach(Colour -> System.out.println(
		 * Colour.c));
		 */
...
//		UserInterface userInterface = new UserInterface();
		...
		/*
		 * Animal cat = new Cat("CAT001"); cat.age = 6; cat.price = 20000; cat.breed =
		 * "CATCAT"; Animal cat1 = new Cat("CAT001"); cat.age = 6; cat.price = 20000;
		 * cat.breed = "CATCAT1"; Animal dog = new Dog("DOG001"); dog.age = 10;
		 * dog.price = 40000; dog.breed = "DOBBER"; Bird duck = new Duck("DUCK001");
		 * duck.age = 9; duck.price = 5000; duck.species = "duckduck"; Bird parrot = new
		 * Parrot("PARROT001"); parrot.age = 1; parrot.price = 2000; parrot.species =
		 * "GREENPARROT"; Animal rabbit = new Rabbit("RABBIT001"); rabbit.age = 2;
		 * rabbit.price = 4500; rabbit.breed = "RABBITBIT"; PetStorage petStorage = new
		 * PetStorage(); petStorage.add(cat); petStorage.add(dog); petStorage.add(duck);
		 * petStorage.add(parrot); petStorage.add(rabbit); petStorage.add(cat1);
		 * UserInterface userInterface = new UserInterface(); Set petList =
		 * petStorage.getPetList(); userInterface.print(petList);
		 * petStorage.remove(cat); System.out.println("After removing");
		 * userInterface.print(petList); System.out.println("Animals list are");
		 * userInterface.printAnimals(petList); System.out.println("Birds list are");
